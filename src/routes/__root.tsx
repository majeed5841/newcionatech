  ...
  head: () => ({
    meta: [
      ...
      { title: "CIONA TECH LLC — Turning Ideas Into Digital Impact" },
      {
        name: "description",
        content:
          "CIONA TECH LLC is a US-based digital marketing and software development agency in Houston, TX. SEO, Google Ads, Web & App Development, CRM, and AI solutions.",
      },
      { name: "author", content: "CIONA TECH LLC" },
      { property: "og:site_name", content: "CIONA TECH LLC" },
      { property: "og:title", content: "CIONA TECH LLC — Turning Ideas Into Digital Impact" },
      {
        property: "og:description",
        content:
          "Grow faster, rank higher, convert better. Premium digital marketing and software development from Houston, Texas.",
      },
