...
import { D as getStylesheetHref, E as getScriptPreloadAttrs, F as executeRewriteInput, I as isRedirect, L as isResolvedRedirect, O as resolveManifestAssetLink, R as rootRouteId, W as invariant, _ as createSerializationAdapter, a as createSsrStreamResponse, b as iu, c as normalizeSsrResponse, d as attachRouterServerSsrUtils, f as getNormalizedURL, g as createRawStreamRPCPlugin, h as defaultSerovalPlugins, i as mergeHeaders, k as resolveManifestCssLink, l as replaceSsrResponse, n as transformPipeableStreamWithRouter, o as defineHandlerCallback, p as getOrigin, r as transformReadableStreamWithRouter, s as isSsrResponse, t as server_exports$1, u as stripSsrResponseBody, v as makeSerovalPlugin, x as su, y as Pu, z as isNotFound } from "../_libs/@tanstack/router-core+[...].mjs";
import { n as createMemoryHistory } from "../_libs/tanstack__history.mjs";
import { n as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { t as require_server_edge } from "../_libs/react-dom.mjs";
import { i as RouterProvider } from "./esm-Dq0SkE5R.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-BTveeLby.js
var server_BTveeLby_exports = /* @__PURE__ */ __exportAll$1({
...
var import_server_edge = /* @__PURE__ */ __toESM(require_server_edge());
...
var renderRouterToString = async ({ router, responseHeaders, children }) => {
	try {
		let html = import_server_edge.renderToString(children);
...
__reExport(server_exports, server_exports$1);
var defaultStreamHandler = (0, server_exports.defineHandlerCallback)(({ request, router, responseHeaders }) => renderRouterToStream({
	request,
	router,
	responseHeaders,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B5DOdOj0.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Kji9GDVi.mjs"),
		import("./start-DJW1AC2h.mjs"),
...
//#endregion
export { server_BTveeLby_exports as i, __exportAll as n, __toCommonJS as r, __esmMin as t };
